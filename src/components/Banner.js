                ...
                <div className="absolute left-1/2 transform -translate-x-1/2 w-full lg:w-3/4 overflow-hidden bottom-0 p-10 bg-gray-100">
                    ...
                    <div className="flex flex-row justify-around flex-wrap">
                        <div className="flex flex-col">
                            ...
                            <select className="py-1 px-2 mt-2">
                        ...
                        <div className="flex flex-col">
                            <span>Departing:</span>
                            <input type="date" className="py-0.5 px-2 mt-2" />
                        </div>
                        <div className="flex flex-col">
                            <span>Returning:</span>
                            <input type="date" className="py-0.5 px-2 mt-2" />
                        ...
                        <div className="flex flex-col">
                            <span>&nbsp;</span>
                            <button className="text-gray-100 bg-gray-400 font-semibold mt-2 px-4 py-1 transition duration-300 hover:bg-red-600">Search</button>
                        </div>
                    </div>
                </div>
            </div>
